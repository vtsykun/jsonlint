...
class Lexer
{
        ...
        while (true) {
            ...
            switch ($symbol) {
                ...
                case self::T_COMMENT:
                    ...
                    $this->skipUntil(self::T_BREAK_LINE);
                    break;
                case self::T_OPEN_COMMENT:
                    if (!($this->flags & JsonParser::ALLOW_COMMENTS)) {
                        $this->parseError('Lexical error on line ' . ($this->yylineno+1) . ". Comments are not allowed.\n" . $this->showPosition());
                    }
                    $this->skipUntil(self::T_CLOSE_COMMENT);
                    break;
    ...
    /**
     * @return 0|1|4|6|8|10|11|14|17|18|21|22|23|24|30|31|32|-1
     */
    ...
    /**
     * @param  int $rule
     * @return 0|4|6|8|10|11|14|17|18|21|22|23|24|30|31|32|-1
     */
